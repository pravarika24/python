...
manipulated in a program. In python, variables are created when you assign a value to them , they do not need explicit declaration to reserve memory space. The declaration happens automatically when ypu assign a value to the variable 
...
print("age:", age)# 📘 Day 02: Variables in Python
...
Understanding variable types
python is dynamically type, type of variable is determined at run time
...
name = "prav"
int(name) #not possible to convert str into float or int
...
#input from user
Use input function to get the age of the user
age = int(input("what is the age"))
print(type(age))
#by default the type is string we have to convert it into int
